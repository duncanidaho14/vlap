...
class User implements UserInterface
{
     ...
     * @Assert\Url(message="Vueillez donner une URL valide pour votre avatar !")
     */
    private $picture;
    ...
    /**
     * @Assert\EqualTo(propertyPath="hash", message="la confirmation du mot de passe n'est pas correcte ")
     */
